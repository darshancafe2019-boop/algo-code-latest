...
import { Landmark, CheckCircle2, DollarSign, Send, Activity } from "lucide-react";

export default function PortfolioPage() {
  const [activeTab, setActiveTab] = useState<"accounts" | "positions" | "capital" | "orders" | "stream">("accounts");
    ...
    <DirectPageLayout activeTab="portfolio">
      <div className="p-3 sm:p-4 md:p-6 space-y-4 max-w-[1750px] mx-auto min-w-0 font-sans">
        <WorkspaceHeader
          ...
          subtitle="Authoritative QuantDataCore multi-broker capital segregation, live position exposure, and OMS order routing"
          category="PORTFOLIO"
          source="DHAN • UPSTOX • DELTA • BINANCE • PAPER"
        />
