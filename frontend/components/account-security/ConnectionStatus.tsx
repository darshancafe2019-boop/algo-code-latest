    ...
    <div className="p-6 rounded-2xl bg-[#121824] border border-[#1A2A3F] shadow-xl">
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-4 border-b border-[#1A2A3F]">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#0B0F17] hover:bg-cyan-950/40 border border-[#1A2A3F] hover:border-cyan-500/40 rounded-xl text-xs font-semibold text-cyan-300 transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
        {providers.map((p) => (
          <div
            key={p.provider_id}
            className="p-3.5 rounded-xl bg-[#0B0F17]/80 border border-[#1A2A3F] flex flex-col justify-between hover:border-cyan-500/30 transition-colors"
          >
            ...
            <div className="flex items-center justify-between text-[11px] text-slate-500 pt-2 border-t border-[#1A2A3F]/60">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4 border-t border-[#1A2A3F]">
        <div className="flex items-center gap-3 p-3 rounded-xl bg-[#0B0F17]/60 border border-[#1A2A3F]">
