...
export function AlertError({ message = "Unable to load alerts feed.", onRetry }: AlertErrorProps) {
  return (
    <div className="p-8 rounded-2xl border border-red-500/30 bg-red-950/20 backdrop-blur-md text-center flex flex-col items-center justify-center my-4">
