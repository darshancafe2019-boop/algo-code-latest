...
export function MetricSkeleton() {
  return (
    <div className="p-4 rounded-xl bg-[#121824] border border-[#1A2A3F] animate-pulse">
...
export function ChartSkeleton({ title }: { title?: string }) {
  return (
    <div className="p-5 rounded-xl bg-[#121824] border border-[#1A2A3F] animate-pulse flex flex-col justify-between min-h-[300px]">
...
export function LeaderboardSkeleton() {
  return (
    <div className="p-5 rounded-xl bg-[#121824] border border-[#1A2A3F] animate-pulse space-y-3">
