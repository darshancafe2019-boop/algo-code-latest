...
export function BacktestSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      {/* Top Banner Skeleton */}
      <div className="h-28 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-6 flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="h-96 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-6 space-y-4">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="h-28 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-4 flex flex-col justify-between">
          ...
          <div className="h-64 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-6 flex flex-col justify-between">
            <div className="h-6 w-1/3 bg-slate-800 rounded"></div>
