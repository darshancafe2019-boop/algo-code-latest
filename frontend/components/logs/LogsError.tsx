...
export function LogsError({ message = "Unable to load real-time system logs", onRetry }: LogsErrorProps) {
  return (
    <div className="bg-[#181214] border border-red-900/60 rounded-2xl p-6 text-center space-y-4 my-4">
      ...
      <div>
        <h3 className="text-base font-bold text-white uppercase tracking-wider">Logging Stream Error</h3>
