...
export function LogsSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      {/* Top Banner Skeleton */}
      <div className="h-24 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-5 flex flex-col justify-between">
        <div className="h-6 w-1/3 bg-slate-800 rounded"></div>
        <div className="h-4 w-2/3 bg-slate-800/60 rounded"></div>
      </div>

      {/* Toolbar Skeleton */}
      <div className="h-14 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-3 flex items-center justify-between gap-4">
