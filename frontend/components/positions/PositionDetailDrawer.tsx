...
export function PositionDetailDrawer({
  ...
  const slP = Number(position.stop_loss || entryP * 0.98);
  const tpP = Number(position.take_profit || entryP * 1.04);
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm animate-in fade-in duration-150 font-sans select-none">
      ...
      <div className="w-full max-w-xl h-full bg-[var(--theme-surface)] border-l border-[var(--theme-border)] shadow-2xl flex flex-col z-10 text-[var(--theme-text-primary)] animate-in slide-in-from-right duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--theme-text-secondary)] mt-0.5 font-mono">
                Position #{position.id} • {position.bot_name || "Bot-1"}
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[var(--theme-elevated)] border border-[var(--theme-border)] shadow-md flex items-center justify-between">
            <div>
              <span className="text-[11px] text-[var(--theme-text-muted)] uppercase tracking-wider font-mono block">
                Floating Mark-to-Market P&L
              </span>
              <div
                className={`text-2xl sm:text-3xl font-extrabold font-mono tabular-nums mt-1 flex items-center gap-1 ${
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 font-mono text-xs">
              <div className="p-3 bg-[var(--theme-elevated)]/60 border border-[var(--theme-border-subtle)] rounded-xl">
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-3 font-mono text-xs">
              <div className="p-3.5 bg-[var(--theme-loss)]/10 border border-[var(--theme-loss)]/30 rounded-xl space-y-1">
                <div className="flex items-center justify-between">
                ...
                <div className="text-base font-extrabold text-[var(--theme-loss)] tabular-nums">
              ...
              <div className="p-3.5 bg-[var(--theme-profit)]/10 border border-[var(--theme-profit)]/30 rounded-xl space-y-1">
                <div className="flex items-center justify-between">
                ...
                <div className="text-base font-extrabold text-[var(--theme-profit)] tabular-nums">
            ...
            <form onSubmit={handleAddNote} className="space-y-2">
              <div className="relative">
                <textarea
                  ...
                  rows={3}
                  className="w-full p-3 bg-[var(--theme-elevated)] border border-[var(--theme-border-subtle)] rounded-xl text-xs text-[var(--theme-text-primary)] placeholder-[var(--theme-text-muted)] focus:outline-none focus:border-[var(--theme-accent)] transition resize-none font-sans"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="ml-auto px-3.5 py-1.5 rounded-xl bg-[var(--theme-accent)] text-[var(--theme-bg)] font-bold text-xs flex items-center gap-1.5 transition disabled:opacity-50"
                >
          ...
          <div className="grid grid-cols-2 gap-2 text-xs font-semibold">
            <button
              ...
              className="p-3 rounded-xl bg-[var(--theme-elevated)] hover:bg-[var(--theme-surface)] text-[var(--theme-text-secondary)] hover:text-[var(--theme-text-primary)] border border-[var(--theme-border-subtle)] flex items-center justify-center gap-2 transition"
            >
        ...
        <div className="p-4 sm:p-5 border-t border-[var(--theme-border)] bg-[var(--theme-elevated)] flex items-center justify-between gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-[var(--theme-surface)] hover:bg-[var(--theme-warning)]/20 text-[var(--theme-text-secondary)] hover:text-[var(--theme-warning)] border border-[var(--theme-border)] text-xs font-bold font-mono transition"
          >
            PARTIAL SCALE EXIT
          </button>
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-[var(--theme-loss)] hover:opacity-90 text-white text-xs font-bold font-mono shadow-md shadow-[var(--theme-loss)]/25 transition active:scale-95"
          >
