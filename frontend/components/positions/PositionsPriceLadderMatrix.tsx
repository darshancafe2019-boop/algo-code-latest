  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 font-sans select-none">
      {positions.map((pos) => {
        ...
        // Derived ladder levels
        const tp2 = isLong ? round2(entryP + (tpP - entryP) * 1.5) : round2(entryP - (entryP - tpP) * 1.5);
        ...
        return (
          <div
            ...
            className="p-5 rounded-2xl bg-[var(--theme-surface)] border border-[var(--theme-border)] shadow-lg space-y-4 cursor-pointer hover:border-[var(--theme-accent)]/50 transition group"
          >
            ...
            <div className="flex items-center justify-between border-b border-[var(--theme-border-subtle)] pb-3">
              ...
              <div className="text-right font-mono tabular-nums">
                ...
                <span className="text-[10px] text-[var(--theme-text-muted)]">
                  Current Mark: ${currP.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2 font-mono text-xs">
              ...
              <div className="p-2.5 rounded-xl bg-[var(--theme-elevated)]/60 border border-[var(--theme-profit)]/20 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[var(--theme-profit)]/60" />
              ...
              <div className="p-2.5 rounded-xl bg-[var(--theme-profit)]/10 border border-[var(--theme-profit)]/40 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Target className="h-3.5 w-3.5 text-[var(--theme-profit)]" />
                  <span className="text-[11px] text-[var(--theme-profit)] font-bold">TP 1 (Take Profit Limit)</span>
                </div>
                <div className="text-right tabular-nums">
                  <span className="font-extrabold text-[var(--theme-profit)]">
              ...
              <div className="p-3 rounded-xl bg-[var(--theme-accent)]/15 border-2 border-[var(--theme-accent)] shadow-md flex items-center justify-between">
                <div className="flex items-center gap-2">
                ...
                <div className="text-right tabular-nums">
                  <span className="text-sm font-extrabold text-[var(--theme-text-primary)]">
                    ${currP.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                  </span>
                  <span
                    className={`text-xs ml-2 font-extrabold ${
                      isProfit ? "text-[var(--theme-profit)]" : "text-[var(--theme-loss)]"
                    }`}
                  >
              ...
              <div className="p-2.5 rounded-xl bg-[var(--theme-elevated)] border border-[var(--theme-border-subtle)] flex items-center justify-between text-[var(--theme-text-muted)]">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[var(--theme-text-muted)]" />
                  <span className="text-[11px] font-semibold">ENTRY / BREAKEVEN</span>
                </div>
              ...
              {trailingSl !== slP && (
                <div className="p-2 rounded-xl bg-[var(--theme-elevated)] border border-[var(--theme-warning)]/30 flex items-center justify-between text-[var(--theme-warning)]">
                  <div className="flex items-center gap-2">
              ...
              <div className="p-2.5 rounded-xl bg-[var(--theme-loss)]/10 border border-[var(--theme-loss)]/40 flex items-center justify-between">
                <div className="flex items-center gap-2">
                ...
                <div className="text-right tabular-nums">
                  <span className="font-extrabold text-[var(--theme-loss)]">
              ...
              <div className="p-2 rounded-xl bg-[var(--theme-elevated)]/40 border border-[var(--theme-border-subtle)] flex items-center justify-between text-[var(--theme-text-muted)] text-[10px]">
            ...
            >
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-[var(--theme-loss)]/15 hover:bg-[var(--theme-loss)] text-[var(--theme-loss)] hover:text-white border border-[var(--theme-loss)]/30 text-xs font-bold font-mono transition"
              >
                SQUARE OFF
              </button>
            </div>
