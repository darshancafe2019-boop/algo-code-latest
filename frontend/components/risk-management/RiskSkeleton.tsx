...
export function RiskSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      {/* Top Header Skeleton */}
      <div className="bg-[#121824] border border-[#1A2A3F] rounded-2xl p-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-[#121824] border border-[#1A2A3F] rounded-xl p-4 space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-[#121824] border border-[#1A2A3F] rounded-2xl p-5 space-y-4">
