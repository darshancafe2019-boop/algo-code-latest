        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          {activeTab === "themes" && (
            <div className="space-y-5">
              {/* AI Core Highlight Showcase */}
              <div className="p-4 rounded-3xl bg-gradient-to-br from-[var(--theme-elevated)] to-[var(--theme-surface)] border border-[var(--theme-border)] shadow-md space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-[var(--theme-accent)]" />
                    <span className="text-xs font-bold font-mono tracking-wider uppercase text-[var(--theme-text-primary)]">
                      AI COMMAND CORES
                    </span>
                  </div>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-[var(--theme-accent)]/15 text-[var(--theme-accent)] border border-[var(--theme-accent)]/30 font-mono font-bold">
                    FLAGSHIP ENGINES
                  </span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {/* JARVIS CORE Card */}
                  <div
                    onClick={() => setTheme("jarvis-core")}
                    className={`p-3.5 rounded-2xl border cursor-pointer transition-all ${
                      draftConfig.themeId === "jarvis-core"
                        ? "bg-[#0B1D3A] border-[#00E5FF] ring-2 ring-[#00E5FF]/40 shadow-lg shadow-[#00E5FF]/20"
                        : "bg-[#060B13]/80 border-[#1D355E] hover:border-[#00E5FF]/60"
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-[#00E5FF] animate-pulse" />
                        <span className="text-xs font-bold text-[#F0F6FC] font-mono">JARVIS CORE</span>
                      </div>
                      {draftConfig.themeId === "jarvis-core" && (
                    ...
                    <p className="text-[11px] text-[#9DB2CE] mt-1">
                      Analytical, calm, deep blue/cyan AI trading matrix for daily research & monitoring.
                    </p>
                    <div className="flex items-center gap-1.5 mt-2.5">
                      <span className="w-4 h-4 rounded-full bg-[#060B13] border border-white/20" title="Obsidian Page" />
                      <span className="w-4 h-4 rounded-full bg-[#0B1528] border border-white/20" title="Navy Surface" />
                      <span className="w-4 h-4 rounded-full bg-[#00E5FF]" title="Electric Cyan Accent" />
                      <span className="w-4 h-4 rounded-full bg-[#00F2A9]" title="Profit Glow" />
                      <span className="w-4 h-4 rounded-full bg-[#FF4757]" title="Loss Coral" />
                    </div>
                  </div>

                  {/* ULTRON CORE Card */}
                  <div
                    onClick={() => setTheme("ultron-core")}
                    className={`p-3.5 rounded-2xl border cursor-pointer transition-all ${
                      draftConfig.themeId === "ultron-core"
                        ? "bg-[#20080C] border-[#FF1E44] ring-2 ring-[#FF1E44]/40 shadow-lg shadow-[#FF1E44]/20"
                        : "bg-[#08080A]/80 border-[#2E2E38] hover:border-[#FF1E44]/60"
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-[#FF1E44] animate-pulse" />
                        <span className="text-xs font-bold text-[#FAFAFA] font-mono">ULTRON CORE</span>
                      </div>
                      {draftConfig.themeId === "ultron-core" && (
                        <span className="text-[9px] px-1.5 py-0.2 rounded bg-[#FF1E44]/20 text-[#FF1E44] font-bold border border-[#FF1E44]/40">
                          ACTIVE
                        </span>
                      )}
                    </div>
                    <p className="text-[11px] text-[#A1A1AA] mt-1">
                      Tactical, high-contrast, graphite/crimson engine for precision execution & risk sentry.
                    </p>
                    <div className="flex items-center gap-1.5 mt-2.5">
                      <span className="w-4 h-4 rounded-full bg-[#08080A] border border-white/20" title="Graphite Page" />
                      <span className="w-4 h-4 rounded-full bg-[#111114] border border-white/20" title="Carbon Surface" />
                      <span className="w-4 h-4 rounded-full bg-[#FF1E44]" title="Tactical Crimson Accent" />
                      <span className="w-4 h-4 rounded-full bg-[#00E676]" title="Matrix Green Profit" />
                      <span className="w-4 h-4 rounded-full bg-[#FF1744]" title="Destructive Red" />
                    </div>
                  </div>
                </div>
              </div>
